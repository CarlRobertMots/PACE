...
**PACE** is a React Native mobile application built with Expo that gamifies the fitness experience. We believe that exercise shouldn't be a chore—it should be a quest.

This app combines a real-time pedometer with RPG mechanics. Every step you take deals damage to a "Boss". The more you walk, the faster you defeat the enemy and level up.

Key features include:

- **Gamified Activity:** Visual Boss Health bars that deplete as you walk.
- **Retro Aesthetic:** Immersive dark mode UI with pixel-art fonts, glassmorphism, and neon shadows.
- **Detailed Analytics:** Track your Day, Week, and Month with interactive circular charts and "Ray" graphs.
- **Cross-Platform:** Optimized for both iOS and Android (including custom Safe Area handling).
...
- [x] **Authentication** (Sign In / Sign Up UI)
- [x] **Step Counter Integration** (Pedometer API)
- [x] **Boss Battle Logic** (Health calculation based on steps)
- [x] **Advanced Charts** (Circular & Ray casting graphs)
- [x] **Android Optimization** (Safe Area & Navigation fixes)
- [x] **Profile & Settings Page**
- [ ] Social Features (Party System)
- [ ] Skins (Equip skins to look cooler)
...
This project was built by a team of four developers as part of our coursework at Tartu Vocational College.

|                                                                                                                                                    | GitHub                                                   | Name        | Role                                 |
| :------------------------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------- | :---------- | :----------------------------------- |
| <a href="https://github.com/CarlRobertMots"><img src="https://github.com/CarlRobertMots.png" width="40" height="40" style="border-radius:50%"></a> | **[@CarlRobertMots](https://github.com/CarlRobertMots)** | Carl-Robert | UX/UI Designer/ Full Stack Developer |
|          <a href="https://github.com/gbrds"><img src="https://github.com/gbrds.png" width="40" height="40" style="border-radius:50%"></a>          | **[@gbrds](https://github.com/gbrds)**                   | Juss Joosep | Lead Back-End Developer              |
|      <a href="https://github.com/EgertL123"><img src="https://github.com/EgertL123.png" width="40" height="40" style="border-radius:50%"></a>      | **[@EgertL123](https://github.com/EgertL123)**           | Egert       | Full Stack Developer                 |
...
Carl-Robert Mõts - robertm6ts@gmail.com

Project Link: [https://github.com/CarlRobertMots/PACE](https://github.com/CarlRobertMots/PACE)
